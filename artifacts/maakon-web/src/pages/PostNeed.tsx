...
import { CheckCircle2, ChevronLeft, ChevronRight, AlertCircle, Info, XCircle } from "lucide-react";
      ...
      <main className="flex-1 mt-16 w-full max-w-lg mx-auto p-4 sm:p-6 flex flex-col">
        ...
        <div className="mb-8 px-2">
          ...
          <div className="relative h-2 bg-secondary rounded-full overflow-hidden">
            <div
              className="absolute top-0 bottom-0 bg-primary transition-all duration-500 ease-out"
              style={{
                width: `${((step - 1) / 2) * 100}%`,
                left: isRtl ? 'auto' : 0,
                right: isRtl ? 0 : 'auto',
        ...
        <div className="flex-1 relative">
          <AnimatePresence custom={1} mode="wait">
            ...
            {step === 1 && (
              ...
              >
                <h2 className="text-2xl font-bold text-foreground">{t('step_1_need')}</h2>
            ...
            {step === 3 && (
              ...
              >
                ...
                {/* Private exact address (for responders, never public) */}
